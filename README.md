...
This is a dockerized version of SuiteCRM including source code for development.

## Install

Simply clone the repository, navigate to it, run 'composer i --ignore-platform-reqs' to install dependancies, and then 'docker-compose up -d' to start the docker app. Once the build is complete navigate to localhost and follow the normal suite installer prompts.
